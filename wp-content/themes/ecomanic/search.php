<?php bunch_global_variable();
	...
	$layout = ecomanic_set( $settings, 'search_page_layout', 'right' );
	$sidebar = ecomanic_set( $settings, 'search_page_sidebar', 'blog-sidebar' );
        ...
        <div class="row clearfix">
			...
			<?php else : ?>
                <div class="<?php echo esc_attr($classes);?> blog_post_area eco-search">
                    <p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'ecomanic' ); ?></p>
                    <aside>
                    <?php get_search_form(); ?>
                    </aside>
                </div>
