 ...
 * Seo Class include functions which are necessary for Seo of theme.
...

{
...

	{
		...
		$this->meta_info = get_post_meta( get_the_id(), '_bunch_seo_settings', true );
...

	{
		...
		$this->meta_info = get_option( '_bunch_tax_seo_settings'.$object->term_id );
...

	{
		...
		echo '<meta name="author" content="'.get_the_author_meta('display_name', ecomanic_set( get_queried_object(), 'post_author')).'" />'."\n";
