<?php bunch_global_variable(); 
	...
	$layout = ecomanic_set( $settings, 'author_page_layout', 'right' );
	$sidebar = ecomanic_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = ecomanic_set( $settings, 'author_page_view', 'list' );
