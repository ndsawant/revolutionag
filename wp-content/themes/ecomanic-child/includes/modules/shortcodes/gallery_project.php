		...
		if( $post_terms ) foreach( $post_terms as $p_term ) $term_slug .= $p_term->slug.' ';?>		
           ...
           <div class="image-box mix mix_all <?php echo esc_attr($term_slug); ?>">
                <div class="inner-box">
                    ...
                    <a href="<?php echo esc_url($post_thumbnail_url);?>" class="lightbox-image btn-zoom" title="<?php the_title(); //esc_html_e('Image Title Here', 'ecomanic');?>"><span class="icon flaticon-round69"></span></a>
                </div>
            </div>
